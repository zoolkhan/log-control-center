...
const confOpen = document.getElementById('config-open');
const confClose = document.getElementById('config-close');
const confSave = document.getElementById('config-save');
...
if (confClose) confClose.onclick = () => { modal.style.display = 'none'; };
